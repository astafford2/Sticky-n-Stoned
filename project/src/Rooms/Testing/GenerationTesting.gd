...
func _ready():
	...
	var fan3 = generateFanRooms(SpawnRoom)
	var fan4 = generateFanRooms(SpawnRoom)
	var fan5 = generateFanRooms(SpawnRoom)
	var fan6 = generateFanRooms(SpawnRoom)
	var BossSegment = generateBossRooms(BossGauntStart, 3, 0)
	moveAllSegments([fan1, fan2, fan3, fan4, fan5, fan6, BossSegment])
	FanPathUpdates(fan1)
	FanPathUpdates(fan2)
	FanPathUpdates(fan3)
	FanPathUpdates(fan4)
	...
	ManualPaths = connectHubs([fan1, fan2, fan3, fan4, fan5, fan6, BossSegment])
